...
const columns: GridColDef[] = [
  ...
  { field: 'role', headerName: 'Role', width: 200, renderCell: (p) => <Chip size="small" label={String(p.value).replace(/_/g, ' ')} variant="outlined" /> },
...
const fields: FieldDef[] = [
  ...
  { name: 'role', label: 'Role', type: 'select', required: true, half: true, options: ROLES.map((r) => ({ value: r, label: r.replace(/_/g, ' ') })) },
